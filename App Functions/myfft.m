function [YFFT,ThetaFFT,YcFFT,YsFFT] = myfft(k,freq0,fsample)
%this is just an implementation for the fft function I created
...
%here I loop over the windows and I force them to slide
    ...
    for jj=2:(Nw/2)                                         % here I do some calculation to achieve constant phase with respect to starting point
